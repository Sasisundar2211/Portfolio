...
// Renders the proficiency bars section.
const Proficiency = () => {
    const { ref, inView } = useInView({
        triggerOnce: true, // Ensures the animation runs only once.
        threshold: 0.5,    // Triggers the animation when 50% of the component is visible.
    });
                    ...
                    {techStack.experience.map((skill, index) => (
                        <div key={index} className="skill-bar-container">
                            ...
                            <div className="w-full bg-muted rounded-full h-2">
                                <div 
                                    // The width is animated from 0% to its actual value when in view.
