              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.techStack.map((tech, techIndex) => (
                    <span 
                      key={techIndex}
                      className="px-4 py-2 bg-black/5 dark:bg-white/10 text-gray-700 dark:text-gray-200 text-sm rounded-full border border-black/10 dark:border-white/20 backdrop-blur-sm"
                    >
                      {tech}
                    </span>
                  ))}
