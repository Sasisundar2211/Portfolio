      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {openSource.display && (
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Open Source Projects</h2>
            <Button 
              asChild
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">{bigProjects.title}</h2>
          ...
          {bigProjects.projects.map((project, index) => (
            <div key={index} className="glass-card overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-6 text-base leading-relaxed">{project.projectDesc}</p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.techStack.map((tech, techIndex) => (
                    <span 
                      key={techIndex}
                      className="px-4 py-2 bg-white/10 text-gray-200 text-sm rounded-full border border-white/20 backdrop-blur-sm"
                    >
                      {tech}
                    </span>
                  ))}
